...
public class MacImSelectFFM {
    ...
    public static class Carbon {
        ...
        public static MemorySegment getObjcLookUpClass(String name) {
            try (Arena arena = Arena.ofConfined()) {
                MemorySegment namePtr = arena.allocateFrom(name);
                return (MemorySegment) mh_objc_lookUpClass.invokeExact(namePtr);
            } catch (Throwable th) {
        ...
        public static MemorySegment getSelector(String name) {
            try (Arena arena = Arena.ofConfined()) {
                MemorySegment namePtr = arena.allocateFrom(name);
                return (MemorySegment) mh_sel_getUid.invokeExact(namePtr);
            } catch (Throwable th) {
                th.printStackTrace(System.err);
                return null;
            }
        ...
        public static MemorySegment mseg_objc_msgSend(MemorySegment target, MemorySegment selector)
                throws Throwable {
            return (MemorySegment) mh_mseg_objc_msgSend.invokeExact(target, selector);
        }

        public static MemorySegment mseg_objc_msgSend(MemorySegment target, MemorySegment selector,
                MemorySegment arg1) throws Throwable {
            return (MemorySegment) mh_mseg_objc_msgSendMseg1.invokeExact(target, selector, arg1);
        }

        public static MemorySegment mseg_objc_msgSend(MemorySegment target, MemorySegment selector,
                long index) throws Throwable {
            return (MemorySegment) mh_mseg_objc_msgSendLong1.invokeExact(target, selector, index);
        }

        public static long long_objc_msgSend(MemorySegment target, MemorySegment selector,
                MemorySegment arg1, MemorySegment arg2) throws Throwable {
            return (long) mh_long_objc_msgSendMseg2.invokeExact(target, selector, arg1, arg2);
        }

        public static long long_objc_msgSend(MemorySegment target, MemorySegment selector)
                throws Throwable {
            return (long) mh_long_objc_msgSend.invokeExact(target, selector);
        }

        public static void dispatch_sync(Runnable task) {
            try (Arena arena = Arena.ofConfined()) {
                MemorySegment ms = Linker.nativeLinker()
                        .upcallStub(mh_dispatchTask.bindTo(task), FunctionDescriptor.ofVoid(), arena);
                mh_dispatch_sync_f.invokeExact(_dispatch_main_q, MemorySegment.NULL, ms);
            } catch (Throwable th) {
                th.printStackTrace(System.err);
            }
        }
    ...
    public static class NSTextInputContext {
        ...
        private static final MemorySegment CLASS_PTR
                = Carbon.getObjcLookUpClass("NSTextInputContext");
        private static final MemorySegment sel_currentInputContext
                = Carbon.getSelector("currentInputContext");
        private static final MemorySegment sel_keyboardInputSources
                = Carbon.getSelector("keyboardInputSources");
        private static final MemorySegment sel_selectedKeyboardInputSource
                = Carbon.getSelector("selectedKeyboardInputSource");
        private static final MemorySegment sel_setValueForKey
                = Carbon.getSelector("setValue:forKey:");
    ...
    public static class NSArray {
        ...
        private static final MemorySegment sel_count
                = Carbon.getSelector("count");
        private static final MemorySegment sel_objectAtIndex
                = Carbon.getSelector("objectAtIndex:");
    ...
    public static class NSString {
        ...
        private static final MemorySegment CLASS_PTR
                = Carbon.getObjcLookUpClass("NSString");
        ...
        public NSString(MemorySegment memorySegment) {
            this.memorySegment = memorySegment;
        }
        ...
        public String utf8String() {
            try {
                MemorySegment strPtr = Carbon.mseg_objc_msgSend(memorySegment, sel_UTF8String)
